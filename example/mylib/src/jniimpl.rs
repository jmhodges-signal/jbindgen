...
pub fn Java_HelloWorld_hello<'a>(
    env: JNIEnv,
...
#[allow(non_snake_case)]
pub fn Java_HelloWorld_helloByte(env: JNIEnv, _class: JClass, input: jbyteArray) -> jbyteArray {
...
#[allow(non_snake_case)]
pub fn Java_HelloWorld_factAndCallMeBack(env: JNIEnv, _class: JClass, n: jint, callback: JObject) {
    let i = n as i32;
...
#[allow(non_snake_case)]
pub fn Java_HelloWorld_counterNew(env: JNIEnv, _class: JClass, callback: JObject) -> jlong {
    let global_ref = env.new_global_ref(callback).unwrap();
    let counter = Counter::new(global_ref);
    return Box::into_raw(Box::new(counter)) as jlong;
}

#[allow(non_snake_case)]
pub fn Java_HelloWorld_counterIncrement(env: JNIEnv, _class: JClass, counter_ptr: jlong) {
    unsafe {
...
#[allow(non_snake_case)]
pub fn Java_HelloWorld_counterDestroy(_env: JNIEnv, _class: JClass, counter_ptr: jlong) {
    unsafe {
...
#[allow(non_snake_case)]
pub fn Java_HelloWorld_asyncComputation(env: JNIEnv, _class: JClass, callback: JObject) {
