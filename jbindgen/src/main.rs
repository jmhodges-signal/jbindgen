...
fn main() -> anyhow::Result<(), anyhow::Error> {
    ...
    let tokens = bindings
        .to_string()
        .parse::<TokenStream>()
        .map_err(|e| anyhow::Error::msg(format!("FIXME welp")))?;
...
fn run_bindgen(c_header_contents: String) -> Result<Bindings, anyhow::Error> {
    return bindgen::builder()
        ...
        .whitelist_function("Java_.*") // FIXME makes this an arg
        ...
        .generate()
        .map_err(|e| anyhow::Error::msg("bindgen failed somehow but won't say how"));
}
